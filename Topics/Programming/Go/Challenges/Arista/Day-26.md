# **Day 26: Configuration Backup and Restore with gNMI**

## **Introduction:** 
The critical role of configuration backup and restore in network operations. How gNMI's `Get` with `CONFIG` type and `Set` with `REPLACE` operation enable declarative full-configuration management.
